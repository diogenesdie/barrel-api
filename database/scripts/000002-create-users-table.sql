create sequence barrel.seq_users;

create table barrel.users
(
...
insert into barrel.users (id, type, username, name, email, password, status, created_at, updated_at, deleted_at)
